...
const Landing = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-blue-50 dark:from-gray-900 dark:to-blue-950 overflow-hidden">
      ...
      <section className="pt-32 pb-20 relative">
        ...
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-0">
          <motion.div 
            ...
            className="absolute -top-[10%] -right-[10%] w-[40%] aspect-square rounded-full bg-primary/20 blur-[100px]"
          />
          <motion.div 
            initial={{ opacity: 0 }}
            animate={{ opacity: 0.4 }}
            transition={{ duration: 1.5, delay: 0.5 }}
            className="absolute -bottom-[20%] -left-[10%] w-[40%] aspect-square rounded-full bg-blue-400/20 dark:bg-blue-600/20 blur-[100px]"
          />
        </div>
        ...
        <Container>
          <div className="flex flex-col lg:flex-row items-center gap-12 relative z-10">
            ...
            >
              <div className="inline-block px-4 py-1.5 mb-3 text-sm font-medium text-primary bg-primary/10 rounded-full">
                AI-Powered Interview Preparation
              </div>
              <h1 className="text-4xl md:text-6xl font-bold tracking-tight leading-tight">
                Your AI-powered <br className="hidden md:inline" />
            ...
            >
              <div className="w-full h-[400px] bg-gradient-to-br from-primary/20 to-primary/5 rounded-lg flex items-center justify-center backdrop-blur-sm border border-white/20 dark:border-gray-800/30 shadow-xl">
                <motion.div 
                  className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[80%] h-[80%] rounded-lg bg-white/80 dark:bg-gray-800/80 shadow-xl p-6"
                  initial={{ y: 20 }}
                  animate={{ y: 0 }}
                  transition={{ 
                    duration: 2, 
      ...
      <section className="py-20">
        <Container>
          <motion.div 
            className="bg-primary/10 rounded-2xl p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8 border border-primary/20 shadow-lg"
          ...
          >
            ...
            <motion.div 
              className="relative w-full md:w-1/3 aspect-square rounded-lg bg-gradient-to-br from-primary/30 to-primary/5 flex items-center justify-center shadow-inner"
...
const FeatureCard = ({ icon, title, description }) => {
  return (
    <motion.div
      variants={fadeIn}
      className="p-6 rounded-lg bg-white dark:bg-gray-800 shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-md transition-all duration-300 card-hover"
